...
public final class UiBinder {
     ...
     * @param targetId       the resource ID of the target view.
     * @param targetProperty the property path on the target view to bind.
     * @param sourceObject   the source object for the binding.
     * @param sourceProperty the property path on the source object to bind.
     ...
     * @param sourceObject   the source object for the binding.
     * @param sourceProperty the property path on the source object to bind.
     * @param mode           the mode for the binding.
     * @return the binding produced by this action.
     */
    public static Binding bind(Activity activity, int targetId, String targetProperty,
     ...
     * @param sourceProperty the property path on the source object to bind.
     * @param mode           the mode for the binding.
     * @param converter      the converter for the binding.
     * @return the binding produced by this action.
     */
    public static Binding bind(Activity activity, int targetId, String targetProperty,
     ...
     * @param targetId       the resource ID of the target view.
     * @param targetProperty the property path on the target view to bind.
     * @param sourceProperty the property path on the activity to bind.
     * @return the binding produced by this action.
     */
    public static Binding bind(Activity activity, int targetId, String targetProperty,
     ...
     *
     * @param activity       the parent Activity.
     * @param targetProperty the property to bind.
     * @param sourceProperty the property path on the activity to bind.
     * @param mode           the mode for the binding.
     * @return the binding produced by this action.
     */
     ...
     * thread.
     *
     * @param targetProperty the target property being bound.
     * @param sourceProperty the source property being bound.
     * @param mode           the mode for the binding.
     * @return the binding produced by this action.
     */
     ...
     * @param targetId       the resource ID of the target view.
     * @param targetProperty the property path on the target view to bind.
     * @param sourceProperty the property path on the view to bind.
     * @return the binding produced by this action.
     */
     ...
     *
     * @param view           the parent View.
     * @param targetProperty the property on the target view to bind.
     * @param sourceProperty the property path on the view to bind.
     * @param mode           the mode for the binding.
     * @return the binding produced by this action.
     */
