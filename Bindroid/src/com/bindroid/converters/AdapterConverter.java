...
public class AdapterConverter extends ValueConverter {
     ...
     * list.
     *
     * @param viewType The type of view to construct for each object in the list.
     */
     ...
     *
     * @param viewType     The type of view to construct for each object in the list.
     * @param recycleViews Whether views should be recycled by the adapter.
     */
     ...
     * @param viewType     The type of view to construct for each object in the list.
     * @param recycleViews Whether views should be recycled by the adapter.
     * @param cacheViews   Whether views should be cached by the adapter.
     */
     ...
     * @param recycleViews     Whether views should be recycled by the adapter.
     * @param cacheViews       Whether views should be cached by the adapter.
     * @param dropDownViewType The type of view to construct for drop-downs.
     */
    public AdapterConverter(Class<? extends View> viewType, boolean recycleViews, boolean cacheViews,
