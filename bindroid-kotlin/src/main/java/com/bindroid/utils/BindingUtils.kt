 ...
 */
fun bind(targetProperty: Property<*>,
         sourceProperty: Property<*>,
         mode: BindingMode = BindingMode.ONE_WAY,
         valueConverter: ValueConverter = ValueConverter.getDefaultConverter()): Binding {
...
inline infix fun <reified TProp> (() -> KProperty<TProp>).bind(
        crossinline source: () -> TProp): Binding {
 ...
 */
fun converter(toSource: ((targetValue: Any?, sourceType: Class<*>?) -> Any?)? = null,
